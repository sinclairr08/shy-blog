...
관계를 표현하는 제약 조건은 1, 2번을 사용하거나 3번을 사용.
...
Cardinaltiy Ratio Constraint 와 Participation Constraint를 하나로 합친 것. 관계를 맺는 두 엔티티 타입에 대해, 각 관계에 참가하는 엔티티의 갯수를 (최솟값, 최댓값) 형태로 나타냄.
